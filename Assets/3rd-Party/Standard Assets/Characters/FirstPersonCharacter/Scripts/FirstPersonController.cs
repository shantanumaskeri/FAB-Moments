...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject btnTouch;
                ...
                if (!PanelsManager.Instance.isPanelOpen)
				{
                    ...
                    if (currentSceneIndex == 5)
                        if (CrossPlatformInputManager.GetAxis("Horizontal") != 0f || CrossPlatformInputManager.GetAxis("Vertical") != 0f)
                            if (InstructionsManager.Instance.instructionID == 0)
                                    GameManager.Instance.CheckPlatformAndSceneToShowInstructions(0);
                }
            }

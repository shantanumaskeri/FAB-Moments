...
public class ScenariosQuizXMLManager : MonoBehaviour
{

	#region SINGLETON INSTANCE

	public static ScenariosQuizXMLManager Instance;
	...
	public TextAsset[] quizDocuments;
	...
	private void LoadXML()
    {
		...
		xmlDoc.LoadXml(quizDocuments[ScenariosVideoManager.Instance.scenarioID].text);
	...
	private void ParseXML(XmlDocument document)
	{
		...
		ScenariosQuizManager.Instance.ConfigureQuiz();
	}

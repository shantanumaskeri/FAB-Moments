...
public class ScenariosAnswersManager : MonoBehaviour
{

	#region SINGLETON INSTANCE

	public static ScenariosAnswersManager Instance;
	...
	{
		ScenariosAnswersXMLManager.Instance.quizData[level].TryGetValue("question", out question);
		ScenariosAnswersXMLManager.Instance.quizData[level].TryGetValue("option1", out option1);
		ScenariosAnswersXMLManager.Instance.quizData[level].TryGetValue("option2", out option2);
		ScenariosAnswersXMLManager.Instance.quizData[level].TryGetValue("option3", out option3);
		ScenariosAnswersXMLManager.Instance.quizData[level].TryGetValue("option4", out option4);
